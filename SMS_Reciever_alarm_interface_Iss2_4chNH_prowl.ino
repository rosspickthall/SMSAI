...
String ver = "2.0 4chNH 02/07/2018";
...
void uploadViaGPRS(char messageToSend[20]){
 ...
 strcat(http_cmd, char2);
 Serial.println(http_cmd);
  
   while(!gprs.join(APN, APN_U, APN_PASS)) {  //change "cmnet" to your own APN
  ...
  if(0 == gprs.connectTCP("pickthall.co", 80)) {
